""" Part of code and idea from https://www.learnopencv.com/average-face-opencv-c-python-tutorial/"""
...
def face_avg(im_path):
    # Dimensions of output image
    w = 600
    h = 600

    # Read points for all images
    allPoints = readPoints(im_path)
    
    # Read all images
    images = readImages(im_path)
...
if __name__ == '__main__' :
    ...
    OUTPUT_IM = face_avg(DIR_PATH)

    if not os.path.exists('results'):
        os.makedirs('results')

    # Save result
    cv2.imwrite('results/{}.png'.format(os.path.dirname(DIR_PATH)), OUTPUT_IM * 255)
